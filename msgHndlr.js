...
module.exports = msgHandler = async (client, message) => {
    try {
        ...
        const ownerNumber = "6281268832734"
        ...
        case '!donasi':
        case '!donate':
            client.sendLinkWithAutoPreview(from, 'https://saweria.co/donate/Ebenezer', donate)
            break
        case '!tts':
        ...
        case '!fb':
            ...
            break
        case '!creator':
            client.sendContact(from, '6281268832734@c.us')
            break
        case '!ig':
        ...
        case '!bc':
            ...
            for (let ids of chatz) {
                ...
                if (!cvk.isReadOnly) await client.sendText(ids, `[ BEN BOT Broadcast ]\n\n${msg}`)
            }
        ...
        case '!demote':
            ...
            break
        case '!join':
            //return client.reply(from, 'Jika ingin meng-invite bot ke group anda, silahkan izin ke wa.me/62812688327342', id)
